...
import { Send, Instagram, Facebook, Youtube, Github } from "lucide-react";
    ...
    <div className="min-h-screen">
      ...
      <section className="pb-8 md:pb-12 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-center text-secondary mb-12">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-2xl mx-auto bg-accent/40 border-2 border-accent rounded-2xl p-8 md:p-12 text-center text-foreground">
            ...
            <p className="text-lg opacity-90">
              If you read this far, we're probably a good match.
            </p>
          </div>
        </div>
      </section>

      <div className="container mx-auto px-4 md:px-6 py-4 md:py-6 border-t bg-muted/50 backdrop-blur-sm">
